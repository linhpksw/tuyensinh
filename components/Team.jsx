...
const Team = () => {
    const people = [
        ...
        },
        {
            ...
            role: 'Chức vụ',
            src: giaovien1,
            bio: 'Cựu học sinh chuyên toán trường chuyên Hưng Yên, giải NHÌ quốc gia môn toán; lớp trưởng lớp chất lượng cao K50 trường ĐHSP Hà Nội; học bổng toàn phần làm tiến sĩ khoa học tại Pháp; giảng viên tổ giải tích trường ĐH SPHN, năm 2017 thầy được vinh dự phong chức danh PGS ở tuổi 35.',
        },
        {
                    ...
                    people.map((person) =>
                        <div key={person.name} className="md:flex gap-10 pb-6 md:pb-12 pt-[10px] md:pt-[1px] border-b-[1px] md:tracking-wide">
                            <div className=" md:w-1/3 lg:w-1/4">
                                <Image src={giaovien1} className="object-cover max-w-[150px] md:max-w-full rounded-lg shadow-lg" alt='teacher' />
                            </div>
                            ...
                            <div className="mt-10 md:mt-2 md:w-2/3 lg:w-3/4">
                                ...
                                <p className="leading-6 text-lg text-indigo-600">{person.role}</p>
